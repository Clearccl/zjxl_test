package com.example.mq_provider_war.config;
...
public class DirectRabbitConfig {
    ...
    //Direct交换机 起名：TestDirectExchange1
    @Bean
    DirectExchange TestDirectExchange1() {
        //  return new DirectExchange("TestDirectExchange1",true,true);
        return new DirectExchange("TestDirectExchange1",true,false);
    }

    //绑定  将队列和交换机绑定, 并设置用于匹配键：TestDirectRouting1
    @Bean
